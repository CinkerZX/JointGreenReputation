getwd()
setwd('../../../Pre-exp/DataN1000R321Thre005V2T150/Data')
# Line 54 also need to update
# Line 128 also need to update
...
T2G_rate <- function(T) { # T is the termination step when N=100, T=150
  # load file names
  ...
  write.csv(df_T2G, file = "../../../Visualization/N1000_Rate321Thre005V2T150/Scurve/Scurvedf_T2G.csv", row.names = FALSE)
}
...
T2G_rate_helper <- function(fileName, T, N){
  ...
  # \| rate 1 | category 3 | time 150 | repeatTime 20
...
setwd("../../../Visualization/N1000_Rate321Thre005V2T150/Scurve")
...
generate_S_Curve(0.25, df_T2G, 100, 0)
generate_S_Curve(0.5, df_T2G, 100, 0.1)
generate_S_Curve(0.75, df_T2G, 100, 0.6)

generate_S_Curve(0.05, df_T2G, 100, 0)
generate_S_Curve(0.1, df_T2G, 100, 0)
generate_S_Curve(0.15, df_T2G, 100, 0)
generate_S_Curve(0.2, df_T2G, 100, 0)
