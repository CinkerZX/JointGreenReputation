getwd()
setwd('../../../Pre-exp/DataN1000R321Thre005V2/Data')
...
T2G_rate <- function(T) { # T is the termination step when N=100, T=50
  ...
  write.csv(df_T2G, file = "../../../Visualization/N1000_Rate321Thre005V2/Scurve/Scurvedf_T2G.csv", row.names = FALSE)
}
...
setwd("../../../Visualization/N1000_Rate321Thre005V2/Scurve")
